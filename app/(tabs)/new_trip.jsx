...
import { View, Text, TextInput, TouchableOpacity, ScrollView, Platform, Modal, Alert } from 'react-native';
    ...
    <View className="flex-1 bg-[#fff4ff]">
      <View className="flex-row justify-between items-center px-6 pt-14 pb-4">
        ...
        >
          ...
          <Text className="text-xl font-pbold text-[#4a3b6b] ml-2">New Trip</Text>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView className="flex-1 px-6">
        <View className="bg-white rounded-2xl p-5 mb-4 shadow-lg border border-[#f0e6ff]">
          ...
          >
            <Text className="text-white font-pbold text-center">Create Trip</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
